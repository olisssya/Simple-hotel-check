...
import {addFavoritesAC} from '../../redux/actionCreators'
...
dispatch(addFavoritesAC(e.target.id))
}
                ...
                <div className={styles.hotel_left}>
                  ...
                  <div className={styles.hotel_left_info}>
                    ...
                    <div className={styles.hotel_left_info_date}>
                      <span>   {lastSearchInfo&&lastSearchInfo[0].startDate
                  ? moment(lastSearchInfo[0].startDate).format('DD MMMM YYYY')
                  : moment().format('DD MMMM YYYY')}</span>
                      <span> - {lastSearchInfo&&lastSearchInfo[0].endDate?lastSearchInfo[0].endDate:1} дней</span>
                    </div>
                    <StarRatings
                ...
                <div className={styles.hotel_right}>
                  ...
                  >
                    <path
                      ...
                      fill="#E55858"   onClick={addFavorite}
                      id={props.hotelId}
                    />
                  </svg>
                  <div className={styles.hotel_right_price}>
                    <span>Price: </span>
                    <span> {props.priceAvg} ₽</span>
                  </div>
                </div>
              </div>
